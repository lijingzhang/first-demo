    ...
    <el-main >
            ...
            <div class="tl">基准货币</div>
             <el-row>
                <el-col :span="6" @click.native="dropDown()" >
                    <img  src="../../assets/images/china.png" class="img1x" alt="" v-if="type=='CNY'">
                    <img  src="../../assets/images/USD.png" class="img1x" alt="" v-if="type=='USD'">
                    <b>{{type}}</b>
                    <i ></i>
                </el-col>
        ...
        <div class="list_group">
             <div class="list_head">
                ...
                <div class="list_item" >
                    <el-row>
                        <el-col :span="10" ><img src="../../assets/images/china.png" class="img2x mr5"><span>CNY</span></el-col>
                        <el-col :span="14" class="red"><span >￥</span>{{cny}}</el-col>
                    </el-row>  
                </div>
                <div class="list_item" >
                    <el-row>
                        <el-col :span="10" ><img src="../../assets/images/USD.png" class="img2x mr5"><span>USD</span></el-col>
   ...
   .list_group i{ vertical-align: middle}
    ...
    .select_head{background: #0d0d0d;padding:15px;color:#fff;
        & .el-row{background: #fff; border-radius: 6px;padding: 10px;line-height:30px;margin-top:15px;color:#333;
            ...
            & i{background: url("../../assets/images/icon_drop.png") no-repeat;display: inline-block;width: 8px;height: 8px; background-size: contain;}
        }
    }
    @function imgpx($px) {
        @return $px / 75px * 1rem;
