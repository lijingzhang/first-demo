      ...
      <div class="p15">
        ...
        <el-row>
            <el-col :span="24" class="tl" @click.native="dropDown('step1')" >
                <img  src="../../assets/images/china.png" class="img2x" alt="" v-if="type1=='CNY'">
                <img  src="../../assets/images/USD.png" class="img2x" alt="" v-if="type1=='USD'">
               <b>{{type1 | countType}}</b>
                <i ></i>
            </el-col>
            <el-col :span="24" >
                <input type="number"  class="w100 tr pr30" v-model="form.srcmoney" ref="srcmoney">
            </el-col>
        </el-row>  
        <el-row>
            <el-col :span="24" class="tl" @click.native="dropDown('step2')" >
                <img  src="../../assets/images/china.png" class="img2x" alt="" v-if="type2=='CNY'">
                <img  src="../../assets/images/USD.png" class="img2x" alt="" v-if="type2=='USD'">
                <b>{{type2 | countType}}</b>
                <i ></i>
            </el-col>
