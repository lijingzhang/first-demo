			...
			<div class=" pl0">
				<el-form ref="form" :rules="rules" :model="form"  label-width="80px">
                   ...
                   <el-form-item label="出生日期" prop="birthday">
						<el-row>
							<el-col :span="20">	<el-date-picker v-model="form.birthday" ref='datepicker' type="date"   placeholder="选择日期" ></el-date-picker></el-col>
                    ...
                    <el-form-item label="地区" prop="address">
						<el-row>
								<el-col :span="20"><el-input v-model="form.address" ref='input'  type="text" placeholder="所在地区" @focus="areapicker()" ></el-input></el-col>
								<el-col :span="4" ><i class="el-icon-arrow-right"></i></el-col>
						</el-row>
    ...
    export default {
		...
		created(){
			this.$nextTick(()=>{
				...
				this.$refs.datepicker.$el.children[0].setAttribute('readOnly','readOnly');
			})
		},
		methods: {
			onSubmit(formName) {
