<template>
    ...
    <el-dialog  :visible.sync="dialogFormVisible">
        ...
        <div slot="footer" class="dialog-footer">
            <el-row :gutter="20">
                <el-col :span="12" ><el-button class="w100" @click="dialogFormVisible= false">取 消</el-button></el-col>
                <el-col :span="12" ><el-button class="w100" type="primary"  @click="onSubmit('form')">确 定</el-button></el-col>
            </el-row>
        </div>
    </el-dialog>
</div>
